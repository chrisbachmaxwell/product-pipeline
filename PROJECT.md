...
- Focused G17/migration verification: 6 files / 55 tests passed and TypeScript no-emit passed. Full-suite and production-build results are recorded in the PR after execution.
