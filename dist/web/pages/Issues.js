...
const Issues = () => {
    ...
    return (_jsx(Page, { title: "Review", fullWidth: true, children: _jsxs(BlockStack, { gap: "500", children: [_jsx(SyncHealth, {}), listings.isLoading ? (_jsx(Card, { children: _jsx(SkeletonBodyText, { lines: 5 }) })) : unavailable ? (_jsx(Card, { children: _jsx(EmptyState, { heading: "Review list unavailable", image: "", action: { content: 'Try again', onAction: () => { void listings.refetch(); } }, children: _jsx(Text, { as: "p", children: "The live check has not finished. Syncing continues in the background." }) }) })) : rows.length === 0 ? (_jsx(Card, { children: _jsx(EmptyState, { heading: "Nothing needs review", image: "", children: _jsx(Text, { as: "p", children: "Every listing matches Shopify." }) }) })) : (_jsxs(BlockStack, { gap: "300", children: [rows.map((row) => {
                            const title = listingDisplayTitle(row);
                            return (_jsx(Card, { children: _jsxs(InlineStack, { align: "space-between", blockAlign: "center", gap: "300", children: [_jsxs(BlockStack, { gap: "100", children: [_jsx(Text, { as: "h2", variant: "headingSm", children: title }), _jsx(Text, { as: "p", tone: "subdued", children: listingSkuLabel(listingDisplaySku(row)) }), _jsx(Text, { as: "p", tone: "critical", children: listingAttentionText(row) })] }), _jsxs(InlineStack, { gap: "300", blockAlign: "center", children: [_jsx(Badge, { tone: "critical", children: "Review" }), _jsx(Link, { to: `/listings/${encodeURIComponent(row.id)}`, "aria-label": `View details for ${title}`, children: "Details" })] })] }) }, row.id));
