...
import { assertAutomationGlobalEnabled, AUTOMATION_GLOBAL_STOPPED, AUTOMATION_KILL_SWITCH_ENABLED_VALUE, AUTOMATION_KILL_SWITCH_ENV, AutomationQuarantinedError, getAutomationGlobalGate, } from './quarantine.js';
describe('G18 global automation quarantine', () => {
    it.each([
        ...
        expect(() => assertAutomationGlobalEnabled(environment)).toThrow(AutomationQuarantinedError);
    });
    it.each(['production', 'test', 'development'])('ignores unrelated NODE_ENV=%s and remains stopped by default', (nodeEnv) => {
