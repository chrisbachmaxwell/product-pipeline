...
export declare const LISTING_CONTROL_SCHEMA_VERSION = 3;
...
export declare function verifyListingControlSchemaV2(database: InstanceType<typeof Database>): void;
...
/** Explicit admin-only upgrade. Runtime open paths never invoke this function. */
export declare function upgradeListingControlSchemaV2ToV3(database: InstanceType<typeof Database>, appliedAtUtc: string): void;
