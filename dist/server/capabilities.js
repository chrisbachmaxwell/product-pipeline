...
registerCapability({
    ...
    description: 'Configure the AI prompt template used to generate product descriptions in the auto-listing pipeline. Also manage PhotoRoom template, pipeline toggles, and other Shopify-related settings.',
    category: 'settings',
    examplePrompts: [
