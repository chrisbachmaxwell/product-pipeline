...
export const EBAY_SCOPE = 'https://api.ebay.com/oauth/api_scope/sell.inventory.readonly';
...
export function tokenFor(provider = 'shopify') {
...
export function transportConfig(overrides = {}) {
    return {
        shopify: {
