...
import { MAX_ORDER_READ_WINDOW_MS, orderWindowQueryForTransport, validateBoundedOrderReadWindow, } from '../order-window.js';
const NOW = '2026-08-11T18:00:00.000Z';
function expectDenied(window, now = NOW) {
    try {
        ...
        expect(error.code).toBe('order-window-denied');
    }
}
