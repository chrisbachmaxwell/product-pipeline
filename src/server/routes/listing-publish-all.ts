...
export function createListingPublishAllRouter(
  dependencies: PublishAllDependencies & { armedCheck?: () => boolean } = {},
): Router {
  ...
  router.get(EXACT_ROUTE, (req: Request, res: Response) => {
  ...
  router.post(EXACT_ROUTE, (req: Request, res: Response) => {
