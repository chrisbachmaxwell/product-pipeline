...
function gcsFolderPath(folder: GcsFolder): string {
 ...
 */
export function isFolderStable(
...
export function getCloudWatcherStatus(): CloudWatcherStatus {
  return {
 ...
 */
export async function startCloudWatcher(): Promise<void> {
  if (!isCloudMode()) {
...
export async function pollOnce(): Promise<void> {
  ...
  for (const folder of folders) {
    ...
    if (processing.has(folderPath)) continue;
